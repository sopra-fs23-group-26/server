...
@Generated(
    ...
    date = "2023-05-22T14:54:57+0200",
    comments = "version: 1.3.1.Final, compiler: javac, environment: Java 17.0.7 (Private Build)"
)
public class DTOMapperImpl implements DTOMapper {
    ...
    public UserGetDTO convertEntityToUserGetDTO(User user) {
        ...
        userGetDTO.setDescription( user.getDescription() );
        userGetDTO.setId( user.getId() );
        userGetDTO.setWord( user.getWord() );
    ...
    public User convertUserPutDTOtoEntity(UserPutDTO userPutDTO) {
        ...
        user.setFriendName( userPutDTO.getFriendName() );
    ...
    public RoomGetDTO convertEntityToRoomGetDTO(Room room) {
        ...
        roomGetDTO.setOwnerId( room.getOwnerId() );
